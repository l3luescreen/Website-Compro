        ...
        return (
            <div className="navbar">
                <nav className="navbar navbar-expand-xl navbar-dark bg-dark justify-content-center navbar-toggler fixed-top">
                    <a className="navbar-brand" href="#">Project Hermes</a>
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav">
                            <li className="nav-item">
                                <a className="nav-link" onClick={this.homePage}>Home <span className="sr-only">(current)</span></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" onClick={this.membersPage}>members</a>
                            </li>
                        </ul>
                    </div>
                </nav>
